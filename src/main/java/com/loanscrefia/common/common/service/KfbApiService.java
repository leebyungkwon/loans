...
public class KfbApiService {
	...
	//네트워크 및 서버상태확인
	public String getHealthCheck(String apiDomain) {
	...
	public String getAuthCode() {
		...
		System.out.println("#########################################");
		System.out.println("#########################################");
        System.out.println("KfbApiService >> getAuthCode() > url :: " + this.getApiDomain() + AuthCodeUrl);
        System.out.println("#########################################");
        System.out.println("#########################################");
		...
		try {
			...
			if(responseCode == 200) {
				...
				System.out.println("#########################################");
				System.out.println("#########################################");
		        System.out.println("KfbApiService >> getAuthCode() > responseJson :: " + responseJson);
		        System.out.println("#########################################");
		        System.out.println("#########################################");
			}
	...
	public String getAuthToken() {
		...
		try {
			...
			if(responseCode == 200) {
				...
				System.out.println("#########################################");
				System.out.println("#########################################");
		        System.out.println("KfbApiService >> getAuthToken() > responseJson :: " + responseJson);
		        System.out.println("#########################################");
		        System.out.println("#########################################");
			}
