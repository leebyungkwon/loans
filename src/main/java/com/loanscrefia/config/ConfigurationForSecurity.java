...
public class ConfigurationForSecurity extends WebSecurityConfigurerAdapter {
    ...
    {
        web.ignoring().antMatchers("/static/fonts/**", "/static/plugin/**", "/static/css/**", "/static/js/**", "/static/img/**", "/static/lib/**", "/static/images/**","/favicon.ico", "/resources/**", "/error", "/static/sample/**");
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
			...
			.antMatchers("/member/admin/adminDetailUpdPage").hasAnyRole("TEMP_MEMBER", "MEMBER","SYSTEM", "ADMIN")
			.antMatchers("/member/user/userStepHistoryPopup").hasAnyRole("ADMIN","SYSTEM","MEMBER")
			.antMatchers("/member/admin/saveAdminUpdate").hasAnyRole("TEMP_MEMBER", "MEMBER","SYSTEM", "ADMIN")
			.antMatchers("/member/admin/reAppr").hasAnyRole("TEMP_MEMBER", "MEMBER","SYSTEM")
			.antMatchers("/member/**").hasAnyRole("MEMBER","SYSTEM", "ADMIN")
