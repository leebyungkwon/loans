...
<style>
  ...
  .error_Wrap .box { width:816px; height:170px; margin:0 auto; background:url("https://www.crefia.or.kr/static/images/portal/common/img_error_bg.png") no-repeat;}
  .error_Wrap .box img { margin:24px 0 0 75px; float:left}
  .error_Wrap .box .text { width:565px; margin:20px 30px 0 10px; float:right;}
  .error_Wrap .box .text h1 { font-size:32px; color:#000; line-height:32px; padding:8px 0; margin-left:-5px;}
...
<div class="error_Wrap">
    <div class="box">
        ...
        <div class="text">
            <h1>요청 페이지가 존재하지 않습니다.</h1>
            <span>해당 URL을 다시 확인하여 주시기 바랍니다. 추후 문제가 계속 된다면 <br />시스템 담당자에게 문의하여 주시기 바랍니다.</span>
        </div>
        <div class="text">
        	<div class="back" onclick="javascript:window.history.back();">이전페이지</div>
        </div>
    </div>
</div>
