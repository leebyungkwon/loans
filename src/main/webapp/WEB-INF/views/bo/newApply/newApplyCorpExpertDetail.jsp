...
<%-- 											<div class="input_check_wrap mgr10">
									...
									<tr>
										...
										<td>
											<div class="input_check_wrap mgr10">
												<input type="checkbox" id="check_cd208" class="check check_cd" <c:if test="${!empty corpExpertList.checkCd208}">checked</c:if>
												<c:if test="${empty corpExpertList.fileType39.fileSeq}">disabled</c:if>
												 data-fileSeq="${corpExpertList.fileType39.fileSeq }" >
												<label for="check_cd208">확인</label>
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div class="input_check_wrap mgr10">
												<input type="checkbox" id="check_cd209" class="check check_cd" <c:if test="${!empty corpExpertList.checkCd209}">checked</c:if>
												<c:if test="${empty corpExpertList.fileType40.fileSeq}">disabled</c:if>
												 data-fileSeq="${corpExpertList.fileType40.fileSeq }" >
												<label for="check_cd209">확인</label>
											</div>
										</td>
									</tr>
								</c:if>
