...
function pageLoad(){
	usersGrid.set({
	    ...
	    , width			: "100%" 
	    , check			: true
		, headCol		: ["","아이디", "이름", "연락처", "구분", "생년월일", "성별", "이메일", "가입일", "마지막</br>로그인일시", "휴면여부", "로그인</br>차단여부", "탈퇴여부"]
		, bodyCol		: 
			[
				...
				,{type:"string"	, name:'gender'			, index:'gender'		, width:"8%"	, align:"center"}
...
function usersDetail(idx, data){
	...
	var userSeq = usersGrid.gridData[idx].memberSeq;
	$("#userSeq").val(userSeq);
