							...
							<td>
								<c:choose>
									<c:when test="${result.userRegInfo.fileType3 ne null }">
										...
										<a href="javascript:void(0);" class="btn_gray btn_del mgl10 goFileDel" data-fileSeq="${result.userRegInfo.fileType3.fileSeq }" data-fileType="3" data-essential="H">삭제</a>
									</c:when>
									<c:otherwise>
										<input type="text" class="w50 file_input" readonly disabled>
							...
							<td>
								<c:choose>
									<c:when test="${result.userRegInfo.fileType14 ne null }">
										...
										<a href="javascript:void(0);" class="btn_gray btn_del mgl10 goFileDel" data-fileSeq="${result.userRegInfo.fileType14.fileSeq }" data-fileType="14" data-essential="H">삭제</a>
									</c:when>
									<c:otherwise>
										<input type="text" class="w50 file_input" readonly disabled>
										<input type="file" name="files" class="inputFile" data-essential="H" style="display: none;"/>
