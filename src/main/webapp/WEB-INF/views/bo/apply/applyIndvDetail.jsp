	...
	<div class="contents">
		...
		<div id="table">
			<table class="view_table">
				...
				<c:choose>
					...
					or result.applyInfo.plStat eq '2' or result.applyInfo.plStat eq '5' or result.applyInfo.plStat eq '7' or result.applyInfo.plStat eq '10'}">
						<tr>
							<th>사유</th>
							<td colspan="3">
		...
		<div id="table02">
			<table class="view_table border_table">
				...
				--%>
				<tr>
					<td class="acenter">정보변경 관련 서류<br>(개명시 주민등록초본, 휴대폰번호 변경시 휴대폰명의확인서 첨부 필요)</td>
					<td>
						<c:choose>
