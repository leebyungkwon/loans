								...
								<table class="view_table">
									...
									<tbody>
										...
										<tr>
											<th>경력시작일</th>
											<td>
												<input type="text" name="careerStartDate" onclick="goDatepickerShow(this);" value="${corpImwonList.careerStartDate }" class="w100" maxlength="10" placeholder="- 포함" data-vd='{"type":"text","len":"10,10","req":true,"msg":"경력시작일(- 포함)을 입력해 주세요."}'>
												<div id="date_cal01" class="calendar01"></div>
											</td>
											<th>경력종료일</th>
											<td>
												<input type="text" name="careerEndDate" onclick="goDatepickerShow(this);" value="${corpImwonList.careerEndDate }" class="w100" maxlength="10" placeholder="- 포함" data-vd='{"type":"text","len":"10,10","req":true,"msg":"경력종료일(- 포함)을 입력해 주세요."}'>
											...
											<td>
												<c:choose>
													<c:when test="${corpImwonList.fileType7 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl10 goFileDel" data-fileSeq="${corpImwonList.fileType7.fileSeq }" data-fileType="7" data-essential="Y" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
											...
											<td>
												<c:choose>
													<c:when test="${corpImwonList.fileType8 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl10 goFileDel" data-fileSeq="${corpImwonList.fileType8.fileSeq }" data-fileType="8" data-essential="Y" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
														<input type="text" class="w50 file_input" readonly disabled>
														<input type="file" name="files" class="inputFile" data-essential="Y" style="display: none;"/>
											...
											<td>
												<c:choose>
													<c:when test="${corpImwonList.fileType10 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl10 goFileDel" data-fileSeq="${corpImwonList.fileType10.fileSeq }" data-fileType="10" data-essential="Y" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
														<input type="text" class="w50 file_input" readonly disabled>
														<input type="file" name="files" class="inputFile" data-essential="Y" style="display: none;"/>
											...
											<td>
												<c:choose>
													<c:when test="${corpImwonList.fileType27 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl10 goFileDel" data-fileSeq="${corpImwonList.fileType27.fileSeq }" data-fileType="27" data-essential="Y" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
														<input type="text" class="w50 file_input" readonly disabled>
														<input type="file" name="files" class="inputFile" data-essential="Y" style="display: none;"/>
											...
											<td>
												<c:choose>
													<c:when test="${corpImwonList.fileType11 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl10 goFileDel" data-fileSeq="${corpImwonList.fileType11.fileSeq }" data-fileType="11" data-essential="Y" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
														<input type="text" class="w50 file_input" readonly disabled>
														<input type="file" name="files" class="inputFile" data-essential="Y" style="display: none;"/>
											...
											<td>
												<c:choose>
													<c:when test="${corpImwonList.fileType28 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl10 goFileDel" data-fileSeq="${corpImwonList.fileType28.fileSeq }" data-fileType="28" data-essential="N" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
														<input type="text" class="w50 file_input" readonly disabled>
											...
											<td>
												<c:choose>
													<c:when test="${corpImwonList.fileType12 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl10 goFileDel" data-fileSeq="${corpImwonList.fileType12.fileSeq }" data-fileType="12" data-essential="H" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
														<input type="text" class="w50 file_input" readonly disabled>
											...
											<td>
												<c:choose>
													<c:when test="${corpImwonList.fileType30 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl10 goFileDel" data-fileSeq="${corpImwonList.fileType30.fileSeq }" data-fileType="30" data-essential="H" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
														<input type="text" class="w50 file_input" readonly disabled>
														<input type="file" name="files" class="inputFile" data-essential="H" style="display: none;"/>
											...
											<td>
												<c:choose>
													<c:when test="${corpImwonList.fileType15 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl10 goFileDel" data-fileSeq="${corpImwonList.fileType15.fileSeq }" data-fileType="15" data-essential="Y" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
														<input type="text" class="w50 file_input" readonly disabled>
														<input type="file" name="files" class="inputFile" data-essential="Y" style="display: none;"/>
