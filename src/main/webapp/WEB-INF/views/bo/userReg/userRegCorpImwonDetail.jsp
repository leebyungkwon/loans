...
function goDataAreaAdd(masterSeq) {
	var callUrl = "/member/user/callUserRegCorpImwonForm?masterSeq="+masterSeq;
...
<div class="cont_area">
	...
	<div class="btn_wrap02">
		<div class="right">
			<a href="javascript:void(0);" class="btn_gray btn_middle mgr5" onclick="goDataAreaAdd('${result.userRegInfo.masterSeq}');">추가</a>
		</div>
	</div>
