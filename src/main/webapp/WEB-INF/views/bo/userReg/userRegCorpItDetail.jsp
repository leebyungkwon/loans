											...
											<td>
												...
												<c:choose>
													<c:when test="${corpItList.fileType19 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl5 goFileDel" data-fileSeq="${corpItList.fileType19.fileSeq }" data-fileType="19" data-essential="N" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
											...
											<td>
												...
												<c:choose>
													<c:when test="${corpItList.fileType20 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl5 goFileDel" data-fileSeq="${corpItList.fileType20.fileSeq }" data-fileType="20" data-essential="N" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
														<a href="javascript:void(0);" class="btn_black btn_small mgl5 goFileUpload">파일찾기</a>
											...
											<td>
												...
												<c:choose>
													<c:when test="${corpItList.fileType37 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl5 goFileDel" data-fileSeq="${corpItList.fileType37.fileSeq }" data-fileType="37" data-essential="N" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
														<a href="javascript:void(0);" class="btn_black btn_small mgl5 goFileUpload">파일찾기</a>
											...
											<td>
												...
												<c:choose>
													<c:when test="${corpItList.fileType38 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl5 goFileDel" data-fileSeq="${corpItList.fileType38.fileSeq }" data-fileType="38" data-essential="Y" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
														<a href="javascript:void(0);" class="btn_black btn_small mgl5 goFileUpload">파일찾기</a>
