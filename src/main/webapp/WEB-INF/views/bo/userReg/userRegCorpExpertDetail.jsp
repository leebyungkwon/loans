							...
							<div id="table03">
								<table class="view_table">
									...
									<tbody>
										...
										<tr>
											<th>교육이수번호</th>
											<td colspan="3"><input type="text" name="plEduNo" value="${corpExpertList.plEduNo }" class="w100" maxlength="10" data-vd='{"type":"text","len":"10,30","req":true,"msg":"교육이수번호를 입력해 주세요."}'></td>
										</tr>
										<tr>
											<th>경력시작일</th>
											<td>
							...
							<div id="table10 eduFileTable">
								<table class="view_table">
									...
									<tbody>
											...
											<td>
												<c:choose>
													<c:when test="${corpExpertList.fileType16 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl10 goFileDel" data-fileSeq="${corpExpertList.fileType16.fileSeq }" data-fileType="16" data-essential="H" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
											...
											<td>
												<c:choose>
													<c:when test="${corpExpertList.fileType31 ne null }">
														...
														<a href="javascript:void(0);" class="btn_gray btn_del mgl10 goFileDel" data-fileSeq="${corpExpertList.fileType31.fileSeq }" data-fileType="31" data-essential="H" data-realDel="Y">삭제</a>
													</c:when>
													<c:otherwise>
														<input type="text" class="w50 file_input" readonly disabled>
														<input type="file" name="files" class="inputFile" data-essential="H" style="display: none;"/>
										...
										<tr class="careerTypOneTr" data-fileType="17" data-fileSeq="${corpExpertList.fileType17.fileSeq }" <c:if test="${corpExpertList.careerTyp eq '2' }">style="display: none;"</c:if>>
