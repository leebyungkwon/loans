								...
								<table class="view_table">
									...
									<tbody>
										...
										<tr>
											...
											<th>주민번호</th>
											<td><input type="text" name="plMZId" value="${corpExpertList.expName }" class="w100" maxlength="14" placeholder="- 포함" data-vd='{"type":"text","len":"14,14","req":true,"msg":"주민등록번호(- 포함)를 입력해 주세요."}'></td>
										</tr>
										<tr>
											<th>금융상품유형</th>
