			...
			<div id="table">
				<table class="view_table">
					...
					<tr>
						<th>법인등록번호</th>
						<td colspan="3">
							<input type="text" id="plMerchantNo" name="plMerchantNo" placeholder="법인등록번호 13자리를 입력해 주세요!"   value="${companyCodeInfo.plMerchantNo}" class="w60" data-vd='{"type":"num","len":"13","req":true,"msg":"법인등록번호 13자리를 입력해 주세요!"}' />
						</td>
					</tr>
					<tr>
						<th>사업자등록번호</th>
						<td colspan="3">
							<input type="text" id="plBusinessNo" name="plBusinessNo"  value="${companyCodeInfo.plBusinessNo}" class="w60" placeholder="사업자등록번호 10자리를 입력해 주세요!"  data-vd='{"type":"num","len":"10","req":true,"msg":"사업자등록번호 10자리를 입력해 주세요!"}' />
						</td>
					</tr>
					<tr>
						<th>회사대표번호</th>
