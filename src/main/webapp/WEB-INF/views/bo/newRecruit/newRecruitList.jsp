...
function pageLoad(){
	...
	recruitGrid.set({
		  id			: "recruitGrid"
  		, url			: "/admin/newRecruit/newRecruitList"
	    , width			: "100%"
...
function goRecruitDetail(idx, data){
	...
	if(plClass == "1"){
		//개인
		$("#recruitDetailFrm").attr("action","/admin/newRecruit/newRecruitIndvDetail");
	}else if(plClass == "2"){
		//법인
		$("#recruitDetailFrm").attr("action","/admin/newRecruit/newRecruitCorpDetail");
	}
