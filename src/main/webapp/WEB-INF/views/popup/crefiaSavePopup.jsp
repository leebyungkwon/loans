...
<table class="popup_table">
	...
	<tbody>
		...
		<tr>
			<th>아이디</th>
			<td class="file">
				<input type="text" class="w50 file_input" id="popMemberId" name="memberId" value="${result.memberId }"  data-vd='{"type":"id","len":"5,11","req":true,"msg":"아이디를 입력해 주세요"}'/>
			</td>
		</tr>
		<tr>
			<th>비밀번호</th>
			<td class="file">
				<input type="password" class="w50 file_input" id="popPassword" name="password" placeholder="최소8자, 문자/숫자/특수문자를 입력하세요."   data-vd='{"type":"pw","len":"8,20","req":true,"msg":"동일한 비밀번호를 입력해 주세요"}' />
			</td>
		</tr>
		<tr>
			<th>비밀번호확인</th>
			<td class="file">
				<input type="password" class="w50 file_input" id="popPasswordChk" placeholder="동일한 비밀번호를 입력"  data-vd='{"type":"pw","len":"8,20","req":true,"msg":"동일한 비밀번호를 입력해 주세요"}' />
			</td>
		</tr>
	</tbody>
</table>
