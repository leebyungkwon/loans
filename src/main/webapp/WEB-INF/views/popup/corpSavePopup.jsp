	...
	<table class="popup_table">
		...
		<tbody>
			...
			<tr>
				<th>법인번호</th>
				<td class="file">
					<input type="text" name="plMerchantNo" placeholder="법인등록번호 14자리를 입력해 주세요 ( - 포함) !" value="${corpInfo.plMerchantNo }" class="w70 file_input" data-vd='{"type":"text","len":"14,14","req":true,"msg":"법인번호(- 포함) 14자리를 입력해 주세요."}'/>
				</td>
			</tr>
