...
<div class="page_title">
	...
	<span class="sub">
		여신금융협회(이하 “협회”)의 대출성 상품 모집인 등록 업무와 관련하여 협회가 귀하의 개인정보를 수집‧이용하고자 하는 경우에는 「개인정보 보호법」제15조, 제22조등에 따라 귀하의 동의를 얻어야 합니다. 
		<br/>
		...
		- 협회의 대출성 상품 모집인 등록 진행경과 등 안내<br/>
		
		2. 수집‧이용할 항목<br/>
		- 소속 회사명, 소속 부서명, 성명, 직위, 시스템 아이디, 이메일, 회사 전화번호, 휴대폰번호<br/>
		
		3. 보유 기간<br/>
		- 위 개인정보는 수집‧이용에 관한 동의일부터 회원 탈회일 또는 동의 철회 시까지 보유‧이용됩니다.<br/>
		
		4. 동의를 거부할 권리 및 동의를 거부할 경우의 불이익<br/>
		- 귀하는 협회의 개인정보 수집‧이용에 동의하지 않을 수 있습니다.<br/> 
		다만, 동의하지 않는 경우 협회의 대출성 상품 모집인 등록 시스템을 이용할 수 없습니다.<br/>
	</span>
</div>
